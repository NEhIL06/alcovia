    ...
    return (
        <ReactLenis root options={{ lerp: 0.05, duration: 1.5 }}>
            ...
            >
                ...
                {/* --- SCROLL CONTAINER --- */}
                <div ref={scrollContainer} className="flex flex-col xl:flex-row xl:flex-nowrap xl:h-screen xl:w-full relative">

                    {/* Q1: FOUNDATION */}
                    <section id="q1" className="horizontal-section min-w-full h-screen flex flex-col xl:flex-row items-center justify-center p-8 xl:p-24 relative border-b xl:border-b-0 xl:border-r border-white/10 bg-[#0B0C15]">
                        <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px]"></div>

                        {/* Quarter Label */}
                        <div className="absolute top-8 left-8 xl:top-12 xl:left-12 z-20">
                            <span className="font-mono text-2xl xl:text-3xl font-bold text-[#D4AF37]">Q1</span>
                    ...
                    {/* Q2: VISIBILITY */}
                    <section id="q2" className="horizontal-section min-w-full h-screen flex flex-col xl:flex-row items-center justify-center p-8 xl:p-24 relative bg-[#E1C250] text-[#0B0C15] overflow-hidden">
                        <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-30 mix-blend-multiply"></div>

                        {/* Quarter Label */}
                        <div className="absolute top-8 left-8 xl:top-12 xl:left-12 z-20">
                            <span className="font-mono text-2xl xl:text-3xl font-bold text-[#0B0C15]">Q2</span>
                            <span className="block text-[10px] font-mono uppercase tracking-widest text-[#0B0C15]/60 mt-1">VISIBILITY</span>
                        </div>

                        <div className="parallax-float hidden xl:flex absolute top-[20%] right-[15%] w-72 h-96 bg-[#F2F2F2] shadow-[20px_20px_0px_0px_rgba(0,0,0,1)] border-2 border-black items-center justify-center rotate-3 z-0">
                            <span className="text-9xl grayscale opacity-20">🎙️</span>
                        </div>

                        <div className="max-w-3xl z-10 relative mix-blend-hard-light">
                            <h2 className="text-7xl xl:text-[10rem] leading-none font-black mb-6 tracking-tighter uppercase">
                                LOUD<br />& KNOWN
                            </h2>
                    ...
                    <section id="q3" className="horizontal-section min-w-full h-screen flex items-center justify-center p-8 relative bg-[#4A0404] text-[#F2F2F2]">
                        ...
                        {/* Quarter Label */}
                        <div className="absolute top-8 left-8 xl:top-12 xl:left-12 z-20">
                            <span className="font-mono text-2xl xl:text-3xl font-bold text-[#ff6b6b]">Q3</span>
                    ...
                    <section id="q4" className="horizontal-section min-w-full h-screen flex flex-col items-center justify-center p-8 relative bg-[#0D3B2E]">
                        ...
                        {/* Quarter Label */}
                        <div className="absolute top-8 left-8 xl:top-12 xl:left-12 z-20">
                            <span className="font-mono text-2xl xl:text-3xl font-bold text-[#D4AF37]">Q4</span>
                        ...
                        <div className="max-w-4xl text-center z-10">
                            ...
                            <div className="space-y-6 text-lg xl:text-2xl font-light text-[#F2F2F2]/80">
                                ...
                                <p className="text-white text-2xl xl:text-4xl font-normal">
                ...
                <section className="min-h-screen py-20 xl:py-32 px-8 xl:px-24 bg-[#0B0C15] flex flex-col justify-center">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="relative">
                            {/* Connection Line */}
                            <div className="hidden xl:block absolute top-1/2 left-0 right-0 h-[2px] bg-gradient-to-r from-[#D4AF37] via-[#E1C250] via-[#ff4d4d] to-[#D4AF37] -translate-y-1/2" />

                            <div className="grid grid-cols-1 xl:grid-cols-4 gap-8 xl:gap-4">
                                {quarters.map((q, index) => (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <h3
                                                className="text-xl xl:text-2xl font-serif italic mb-2"
                                                style={{ color: q.color }}
                                            >
                                                {q.title}
                                            </h3>
                ...
                <section className="min-h-screen flex flex-col items-center justify-center px-8 text-center relative overflow-hidden bg-[#0B0C15]">
                    ...
                    >
                        <button
                            onClick={() => openModal("outside_school_cta", "Begin Your Journey")}
