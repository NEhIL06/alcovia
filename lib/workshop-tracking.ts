...
const DEFAULT_WORKSHOP_PAYMENT_URL = "https://rzp.io/rzp/jWixlCh"
...
export async function beginWorkshopCheckout(
  ...
  const rzp = new RazorpayClass({
    ...
    notes: {
      ...
      workshop_title: WORKSHOP_DETAILS.title,
      workshop_date: WORKSHOP_DETAILS.dateIso,
      workshop_date_label: WORKSHOP_DETAILS.dateLabel,
      workshop_slug: WORKSHOP_DETAILS.slug,
      workshop_venue: WORKSHOP_DETAILS.locationLabel,
