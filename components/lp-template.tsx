...
function HeroSection({ subtitle, headline, highlight, body, primaryCta, secondaryCta }: HeroProps) {
  ...
  return (
    <section ref={ref} className="relative h-[100svh] min-h-[580px] sm:min-h-[700px] flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        >
          <CTAButton>{primaryCta}</CTAButton>
          <a
            href="#problems"
...
export function LPTemplate({ heroSubtitle, heroHeadline, heroHighlight, heroBody, primaryCta, secondaryCta }: LPTemplateProps) {
  return (
    <>
      <LPNavbar />
      <main>
