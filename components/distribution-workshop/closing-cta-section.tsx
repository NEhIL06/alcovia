    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="lp-fade-in text-[clamp(1.75rem,5vw,3.5rem)] font-[family-name:var(--font-milan)] leading-tight text-white mb-3 sm:mb-4">
          Ready to own{" "}
          <br />
          <span style={{ color: ACCENT, textShadow: `0 0 40px ${ACCENT_DIM}0.3)` }}>the feed?</span>
        </h2>
        ...
        <div className="lp-fade-in space-y-5">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8">
            <a
              ...
              className="flex items-center gap-2 text-sm text-white/50 hover:text-[#D4A853] transition-colors font-[family-name:var(--font-satoshi)]"
            >
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <button
              onClick={copyLink}
              className="relative w-9 h-9 sm:w-10 sm:h-10 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:text-[#D4A853] hover:border-[#D4A853]/20 hover:bg-[#D4A853]/[0.05] transition-all duration-300"
              aria-label="Copy workshop link"
            >
              {copied ? (
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-4 h-4 text-[#D4A853]">
