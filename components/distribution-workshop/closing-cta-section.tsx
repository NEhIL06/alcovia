...
const WORKSHOP_URL = "https://alcovia.life/workshop2";
const WA_TEXT = encodeURIComponent(
  "Join Alcovia's Distribution Monopoly Workshop for Teenagers! May 30th in Gurgaon. Learn the playbook behind hooks, niches, and monetisation from active creators. " + WORKSHOP_URL
);
const X_TEXT = encodeURIComponent(
  "Check out Alcovia's Distribution Monopoly Workshop for Teens! Learn to build a real audience from active creators. May 30th, Gurgaon."
);
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="lp-fade-in text-[clamp(1.75rem,5vw,3.5rem)] font-[family-name:var(--font-milan)] leading-tight text-white mb-3 sm:mb-4">
          Ready to own{" "}
          <br />
          <span style={GOLD_TEXT_STYLE}>the feed?</span>
        </h2>
        ...
        <p className="lp-fade-in text-sm sm:text-base lg:text-lg text-white/60 font-[family-name:var(--font-satoshi)] max-w-xl mx-auto mb-6 sm:mb-10">
          Seats are strictly capped to keep this a real working session, not a lecture hall. Once every spot is claimed, registration permanently closes.
        </p>
        ...
        <div className="lp-fade-in flex flex-col items-center gap-5">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-baseline gap-1.5">
              <span className="text-4xl sm:text-5xl font-[family-name:var(--font-monument)] font-bold" style={GOLD_TEXT_STYLE}>
                &#8377;3,999
              </span>
        ...
        <div className="lp-fade-in space-y-5">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8">
            <a
              ...
              className="flex items-center gap-2 text-sm text-white/50 hover:text-[#EABF36] transition-colors font-[family-name:var(--font-satoshi)]"
            >
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <button
              onClick={copyLink}
              className="relative w-9 h-9 sm:w-10 sm:h-10 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:text-[#EABF36] hover:border-[#EABF36]/20 hover:bg-[#EABF36]/[0.05] transition-all duration-300"
              aria-label="Copy workshop link"
            >
              {copied ? (
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-4 h-4 text-[#EABF36]">
