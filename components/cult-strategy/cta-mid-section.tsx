  ...
  return (
    <section className="relative py-8 sm:py-16 overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 60% at 50% 50%, rgba(255,107,43,0.06) 0%, transparent 60%)",
        }}
      />

      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <motion.div
          className="relative border border-[#FF6B2B]/15 rounded-3xl overflow-hidden bg-[#FF6B2B]/[0.03]"
        ...
        >
          ...
          <div className="p-5 sm:p-10 lg:p-14">
            ...
            >
              ...
              >
                <span
                  className="relative z-10 inline-flex items-center gap-3 text-white font-[family-name:var(--font-monument)] uppercase tracking-wider text-sm sm:text-base px-8 sm:px-10 py-3.5 sm:py-4 rounded-full font-semibold transition-all duration-500 group-hover:scale-105"
