  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 70% 60% at 50% 80%, rgba(255,107,43,0.06) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            <span
              className="relative z-10 inline-flex items-center gap-3 text-white font-[family-name:var(--font-monument)] uppercase tracking-wider text-sm sm:text-base px-10 sm:px-14 py-4 sm:py-5 rounded-full font-semibold transition-all duration-500 group-hover:scale-105 group-hover:brightness-110"
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8">
            <a
              ...
              className="flex items-center gap-2 text-sm text-white/50 hover:text-[#FF6B2B] transition-colors font-[family-name:var(--font-satoshi)]"
            >
              <svg
                viewBox="0 0 24 24"
                fill="none"
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <a
              ...
              className="w-9 h-9 sm:w-10 sm:h-10 rounded-full border border-[#F7F7F3]/10 flex items-center justify-center text-[#F7F7F3]/30 hover:text-[#FF6B2B] hover:border-[#FF6B2B]/30 transition-all duration-300"
          ...
          <button
            ...
            className="inline-flex items-center gap-2 text-xs text-white/30 hover:text-[#FF6B2B]/60 transition-colors font-[family-name:var(--font-satoshi)] tracking-wider uppercase mt-4 cursor-pointer"
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
