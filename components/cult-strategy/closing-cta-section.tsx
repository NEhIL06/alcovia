...
const WA_TEXT = encodeURIComponent(
  "Join the Alcovia Superfood Workshop for Teenagers! May 2nd in Gurgaon. Build a real snack brand in 4 hours. Only 17 spots left. " + WORKSHOP_URL
);
const X_TEXT = encodeURIComponent(
  "Check out Alcovia's Superfood Workshop for Teenagers! Build a real snack brand in 4 hours. May 2nd, Gurgaon. Only 17 spots left!"
);
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="lp-fade-in space-y-5">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <a href={`https://wa.me/?text=${WA_TEXT}`} target="_blank" rel="noopener noreferrer" className="w-9 h-9 sm:w-10 sm:h-10 rounded-full border border-gray-200 flex items-center justify-center text-[#9ca3af] hover:text-[#22C55E] hover:border-[#22C55E]/30 hover:bg-[#22C55E]/[0.05] transition-all duration-300" aria-label="Share on WhatsApp">
            ...
            <a href={`https://twitter.com/intent/tweet?text=${X_TEXT}&url=${encodeURIComponent(WORKSHOP_URL)}`} target="_blank" rel="noopener noreferrer" className="w-9 h-9 sm:w-10 sm:h-10 rounded-full border border-gray-200 flex items-center justify-center text-[#9ca3af] hover:text-[#22C55E] hover:border-[#22C55E]/30 hover:bg-[#22C55E]/[0.05] transition-all duration-300" aria-label="Share on X">
            ...
            <button
              onClick={copyLink}
              className="relative w-9 h-9 sm:w-10 sm:h-10 rounded-full border border-gray-200 flex items-center justify-center text-[#9ca3af] hover:text-[#22C55E] hover:border-[#22C55E]/30 hover:bg-[#22C55E]/[0.05] transition-all duration-300"
              aria-label="Copy workshop link for Instagram"
            >
              {copied ? (
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-4 h-4 text-[#22C55E]">
