...
// --- DATA CONFIGURATION ---
const team = [
    { id: "01", name: "Sahil Puri", role: "Founder", img: "/images/team/sahil.png", experience: "Ex-Chief of Staff at Nothing || Ex-Category Head Meesho || Noise || Flipkart || Panasonic || MBA, IIM Indore" },
    ...
    { id: "03", name: "Farah", role: "Strategy Head", img: "/images/team/farah.png", experience: "Ex-Senior Advisor at Keslio || Ex-McKinsey" },
                        ...
                        {activeMember && (
                            ...
                            >
                                <div className="relative w-full h-full overflow-hidden rounded-3xl bg-[#111]">
                                    ...
                                    {(activeMember as any).experience && (
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="absolute bottom-0 left-0 w-full p-8">
                                    ...
                                    {(mobileSelectedMember as any).experience && (
                                        <p className="font-mono text-xs leading-relaxed text-white/80 mt-4">
                                            {(mobileSelectedMember as any).experience}
                                        </p>
                                    )}
                                </div>
                ...
                <div ref={footerTrackRef} className="relative h-[120vh] w-full">
                    <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
                        ...
                        >
                            ...
                            <button onClick={() => openModal("team_page_cta", "Apply for Cohort 2026")} className="inline-block border border-[#EABF36] text-[#EABF36] px-12 py-4 font-mono uppercase hover:bg-[#EABF36] hover:text-black transition-all z-10">
